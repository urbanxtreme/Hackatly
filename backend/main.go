...
r.Use(func(c *gin.Context) {
	...
	protected.Use(AuthMiddleware())
	{
		...
		protected.GET("/tasks/log", GetTaskLogsHandler)
		protected.PUT("/robots/:id/battery", UpdateRobotBatteryHandler)
		protected.POST("/analytics", UpdateAnalyticsHandler)
		protected.GET("/analytics", GetAnalyticsSummaryHandler)
